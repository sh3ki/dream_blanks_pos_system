 ...
 * All icons are 2D, minimalist, stroke-based (Heroicons outline style)
 */
...
if (!function_exists('icon')) {
    function icon(string $name, int $size = 18, string $class = ''): string
    {
        $icons = [
            ...
            'pos'            => '<path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-1.5 5h11"/><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/>',
            ...
            'variations'     => '<path d="M20.59 13.41l-7.17 7.17a2 2 0 0 1-2.83 0L2 12V2h10l8.59 8.59a2 2 0 0 1 0 2.82z"/><line x1="7" y1="7" x2="7.01" y2="7"/>',
            ...
            'forward'        => '<polyline points="13 17 18 12 13 7"/><path d="M6 12h12"/>',
            'lineup'         => '<line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/>',
            'drag-handle'    => '<circle cx="9" cy="5" r="1.5" fill="currentColor"/><circle cx="9" cy="12" r="1.5" fill="currentColor"/><circle cx="9" cy="19" r="1.5" fill="currentColor"/><circle cx="15" cy="5" r="1.5" fill="currentColor"/><circle cx="15" cy="12" r="1.5" fill="currentColor"/><circle cx="15" cy="19" r="1.5" fill="currentColor"/>',
        ];
