  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    .login-brand::before {
      ...
      background:
        radial-gradient(ellipse at 20% 30%, rgba(255,255,255,.10) 0%, transparent 55%),
    ...
    .login-card .form-label {
      ...
      letter-spacing: .05em; color: #505050; display: block; margin-bottom: 6px;
    }
    ...
    .login-card .form-input:focus {
      border-color: #0056B3; box-shadow: 0 0 0 3px rgba(0,86,179,.12);
    ...
    .login-forgot a { font-size: .82rem; color: #808080; text-decoration: none; transition: color .15s; }
    .login-forgot a:hover { color: #0056B3; }
