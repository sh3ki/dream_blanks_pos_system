  ...
  try {
    ...
    document.getElementById('vrmoBody').innerHTML = `
      ...
      <div class="table-wrapper"><table class="data-table">
        <thead><tr><th>Code</th><th>Name</th><th>Type</th><th>Color</th><th>Size</th><th style="text-align:right">Current Stock</th><th style="text-align:right">Requested</th><th style="text-align:right">Received</th></tr></thead>
        <tbody>${items}</tbody>
      </table></div>`;
